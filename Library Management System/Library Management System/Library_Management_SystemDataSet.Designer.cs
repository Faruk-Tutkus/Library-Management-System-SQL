...
namespace Library_Management_System {
    ...
    public partial class Library_Management_SystemDataSet : global::System.Data.DataSet {
        ...
        public partial class tbl_UsersDataTable : global::System.Data.TypedTableBase<tbl_UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tbl_UsersRow Addtbl_UsersRow(string İsim) {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserRow AddUserRow(string LoginName, byte[] PasswordHash, string FirstName, string LastName) {
        ...
        public partial class tbl_UsersRow : global::System.Data.DataRow {
            ...
            public string İsim {
                get {
                    try {
                        return ((string)(this[this.tabletbl_Users.İsimColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'İsim\' in table \'tbl_Users\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletbl_Users.İsimColumn] = value;
                }
            }
            ...
            public bool IsİsimNull() {
                return this.IsNull(this.tabletbl_Users.İsimColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetİsimNull() {
                this[this.tabletbl_Users.İsimColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Library_Management_System.Library_Management_SystemDataSetTableAdapters {
    ...
    public partial class tbl_UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tbl_Users] ([İsim]) VALUES (@İsim)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, İsim FROM dbo.tbl_Users";
        ...
        public virtual int Fill(Library_Management_SystemDataSet.tbl_UsersDataTable dataTable) {
        ...
        public virtual Library_Management_SystemDataSet.tbl_UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Library_Management_SystemDataSet.tbl_UsersDataTable dataTable = new Library_Management_SystemDataSet.tbl_UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Library_Management_SystemDataSet.tbl_UsersDataTable dataTable) {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[User] WHERE (([UserID] = @Original_UserID) AND ([LoginName] = @Original_LoginName) AND ([PasswordHash] = @Original_PasswordHash) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)))";
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([LoginName], [PasswordHash], [FirstName], [LastName]) V" +
                "ALUES (@LoginName, @PasswordHash, @FirstName, @LastName);\r\nSELECT UserID, LoginN" +
                "ame, PasswordHash, FirstName, LastName FROM [User] WHERE (UserID = SCOPE_IDENTIT" +
                "Y())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [LoginName] = @LoginName, [PasswordHash] = @PasswordHash, [FirstName] = @FirstName, [LastName] = @LastName WHERE (([UserID] = @Original_UserID) AND ([LoginName] = @Original_LoginName) AND ([PasswordHash] = @Original_PasswordHash) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)));
SELECT UserID, LoginName, PasswordHash, FirstName, LastName FROM [User] WHERE (UserID = @UserID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT UserID, LoginName, PasswordHash, FirstName, LastName FROM dbo.[User]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(Library_Management_SystemDataSet.UserDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual Library_Management_SystemDataSet.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Library_Management_SystemDataSet.UserDataTable dataTable = new Library_Management_SystemDataSet.UserDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Library_Management_SystemDataSet.UserDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        public virtual int Delete(int Original_UserID, string Original_LoginName, byte[] Original_PasswordHash, string Original_FirstName, string Original_LastName) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string LoginName, byte[] PasswordHash, string FirstName, string LastName) {
            if ((LoginName == null)) {
        ...
        public virtual int Update(string LoginName, byte[] PasswordHash, string FirstName, string LastName, int Original_UserID, string Original_LoginName, byte[] Original_PasswordHash, string Original_FirstName, string Original_LastName, int UserID) {
            if ((LoginName == null)) {
                throw new global::System.ArgumentNullException("LoginName");
            }
            else {
            ...
            if ((Original_PasswordHash == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((byte[])(Original_PasswordHash));
            }
            if ((Original_FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string LoginName, byte[] PasswordHash, string FirstName, string LastName, int Original_UserID, string Original_LoginName, byte[] Original_PasswordHash, string Original_FirstName, string Original_LastName) {
            return this.Update(LoginName, PasswordHash, FirstName, LastName, Original_UserID, Original_LoginName, Original_PasswordHash, Original_FirstName, Original_LastName, Original_UserID);
        }
    }
